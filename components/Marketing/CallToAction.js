    ...
    <section className="py-12 sm:pb-16 lg:pb-20 xl:pb-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl xl:max-w-[100rem]">
        <div className="grid items-center grid-cols-1 gap-y-12">
          <h1 className="text-center text-4xl font-light text-white sm:text-5xl lg:text-6xl xl:text-6xl mb-6">
          ...
          <h1 className="text-center text-4xl text-white px-32 mt-12">
