...
const CallToAction = () => {
  return (
    <section className="md:pt-24 pt-12 py-12 sm:pb-16 lg:pb-20 xl:pb-24">
        ...
        <div className="grid items-center grid-cols-1 gap-y-12">
          ...
          <div className="grid grid-cols-1 gap-3 md:gap-0 md:grid-cols-3 items-center text-center relative">
            <div className='flex items-center justify-center md:border-r border-gray-400 border-opacity-20'>
              ...
              <h1 className="text-xl md:text-2xl text-foreground">Instant Dubbing</h1>
            </div>
            <div className='flex items-center justify-center md:border-r border-gray-400 border-opacity-20'>
              <Image src='/trending.png' width={512} height={512} className='h-12 w-12 mr-4 filter -hue-rotate-30' alt='' />
              <h1 className="text-xl md:text-2xl text-foreground">Scalable & Affordable</h1>
            </div>
            <div className='flex items-center justify-center'>
              <Image src='/speed.png' width={512} height={512} className='h-12 w-12 mr-4 filter -hue-rotate-30' alt='' />
              <h1 className="text-xl md:text-2xl text-foreground">Quick Turnaround Time</h1>
            </div>
            <div className="absolute -bottom-6 md:-bottom-10 left-0 w-full h-[2px] bg-gradient-to-r from-cyan-500 to-purple-500"></div>
          </div>
          <h1 className="text-center text-3xl md:text-4xl text-foreground px-5 md:px-32 mt-12">
