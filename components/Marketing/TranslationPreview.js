      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="border border-foreground-300 w-full rounded-3xl text-foreground flex flex-row">
            ...
            <div className="w-1/2 flex justify-center flex-col px-16 gap-5">
                <p className="text-3xl font-medium">Automatically translate video<br/>& audio <span className="italic"><span className="font-semibold font-serif">into</span> 130+ <span className="font-semibold font-serif">languages.</span></span></p>
                <p className="text-base">Expand your global reach and create new revenue streams with localized marketing, educational, or entertainment content</p>
                <Button color="primary" size="lg" className="w-min mt-6">Translate video & audio</Button>
            </div>
        </div>
      </div>
    </section>
