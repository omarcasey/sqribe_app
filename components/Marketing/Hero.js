                ...
                <div className="grid grid-rows-1 lg:grid-cols-2 lg:grid-rows-none">
                    <div className="flex flex-col items-center lg:items-start">
                        ...
                        <div className="relative inline-flex items-center justify-center mt-8 sm:mt-12 group">
                            ...
                            <a onClick={() => document.getElementById('newsletter').scrollIntoView({ behavior: 'smooth' })} className="relative inline-flex items-center justify-center px-8 py-3 text-base font-normal text-foreground bg-foreground-50 border border-transparent rounded-full" role="button"> Join the Waitlist for Early Access </a>
                        </div>
                        <div>
