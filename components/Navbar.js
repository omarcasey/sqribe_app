...
const Navbar = () => {
    ...
    return (
        <header className={`py-4 sm:py-6 border-b-2 border-gray-800 z-[100] sticky top-0 bg-opacity-0 backdrop-blur-md transition-all duration-300 ${scrolling ? "bg-black" : ""}`}>
                ...
                <div className="flex items-center justify-between">
                    <div className="shrink-0">
                        <Link href="/" onClick={handleClick} className="flex items-center">
                            ...
                            <h1 className="text-white font-bold text-xl tracking-widest">Sqribe</h1>
                        </Link>
                    </div>
                    ...
                    <nav className="hidden ml-10 mr-auto space-x-10 lg:ml-20 lg:space-x-12 md:flex md:items-center md:justify-start">
                        <a href="#" title="" className={`text-lg font-semibold ${scrolling ? "text-white" : "text-gray-400"} transition-all duration-200 hover:text-white hover-underline`}> Products </a>
