...
const Hero = () => {
    return (
        <section class="py-12 sm:pb-16 lg:pb-20 xl:pb-24" id='hero'>
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="grid grid-rows-1 lg:grid-cols-2 lg:grid-rows-none">
                    <div class="flex flex-col items-center lg:items-start">
                        <p class="text-sm font-normal tracking-widest text-gray-300 uppercase text-center lg:text-left">A HUB FOR YOUTUBERS, CONTENT CREATORS & AGENCIES</p>
                        <h1 class="mt-6 text-4xl font-semibold text-white sm:mt-10 sm:text-5xl lg:text-6xl xl:text-8xl text-center lg:text-left"><span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-purple-500 relative z-10">AI-Powered Multilingual</span><br /> Content Solutions</h1>
