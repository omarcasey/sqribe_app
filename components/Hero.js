            ...
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="relative">
                    <div class="lg:w-2/3">
                        ...
                        <p class="max-w-lg mt-4 text-xl font-normal text-gray-400 sm:mt-8">Sqribe.ai streamlines your video production with automated captions, voice overs, translations, and dubbing in multiple languages, powered by advanced AI algorithms.</p>
                        <div class="relative inline-flex items-center justify-center mt-8 sm:mt-12 group">
                            ...
                            <a href="#" title="" class="relative inline-flex items-center justify-center px-8 py-3 text-base font-normal text-white bg-black border border-transparent rounded-full" role="button"> Get Started with Sqribe </a>
                        </div>
                    ...
                    <div class="mt-8 md:absolute md:mt-0 md:top-32 lg:top-[3.8rem] md:right-32">
                        <img class="w-full max-w-xs mx-auto lg:max-w-lg xl:max-w-xl rotate-90" src="abstract.png" alt="" />
                    </div>
                </div>
            </div>
        </section>
